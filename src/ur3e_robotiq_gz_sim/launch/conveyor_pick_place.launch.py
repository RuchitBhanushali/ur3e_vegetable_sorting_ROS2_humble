...
def launch_setup(context, *args, **kwargs):
    ...
    demo = Node(
        ...
        executable="conveyor_pick_place_script.py",
        output="screen",
        parameters=[{
            "use_sim_time": True,
            "world_name": "conveyor_base",
            "tool_frame": "tool0",
    ...
    cubes = Node(
        package="ur3e_robotiq_gz_sim",
        executable="cube_conveyor_node.py",
        output="screen",
        parameters=[{
            "world_name": "conveyor_base",
            "cube_keep_count": 3,
            "cube_spacing": 0.18,
            "cube_front_speed": 0.65,
            "cube_back_speed": 0.65,
        }],
    )
    ...
    start_after_spawn = RegisterEventHandler(
        OnProcessExit(
            ...
            on_exit=[
                ...
                TimerAction(period=3.2, actions=[cubes]),
            ],
        )
    )
